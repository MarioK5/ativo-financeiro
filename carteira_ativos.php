...
//	$resp->alert('Carteiras do cliente: '.$idCliente); return $resp;
	...
	$tela .= '<table border="0" width=100%>
			    <div class="row" style="color:white; background-color:#8ecae6;">
				    ...
				    <input type="button" value="Criar Nova Carteira"  class="btn btn-success btn-sm" onclick="xajax_cadastrar_carteira(document.querySelector(\'username\'),'.$idCliente.'); return false;">
				</div>
